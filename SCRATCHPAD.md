...
### 2026-06-11 — Email deliverability: verify-on-send + dead-email surfacing + Email Verifier tool — ALL SHIPPED TO PROD (branch `email-verify-on-send` → `admin-email-verifier` → `admin-needs-email-redesign`)
