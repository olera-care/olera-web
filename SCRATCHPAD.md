...
- 🟡 **Verify each state's "helpline" actually answers the thing we say it does.** The LA near-miss (`1-833-577-6532` is Elderly Protective Services, an abuse-reporting line, described by a secondary source as a general senior helpline) is the same class as the OCDD number. Aggregator-sourced phone numbers need a primary-source check before they reach a letter.
