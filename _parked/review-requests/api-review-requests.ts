/**
 * API Route: POST /api/review-requests
 *
 * Sends review request emails to clients on behalf of a provider.
 * This file should be placed at: app/api/review-requests/route.ts
 *
 * Dependencies:
 * - lib/supabase/server.ts (createClient)
 * - lib/admin.ts (getServiceClient)
 * - lib/email.ts (sendEmail)
 * - lib/email-templates.tsx (reviewRequestEmail)
 */
