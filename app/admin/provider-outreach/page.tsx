    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {isSearchResult ? (
          ...
          <>
            {/* Banner indicating cross-stage search */}
            <div className="px-5 py-2 bg-blue-50 border-b border-blue-100 text-sm text-blue-700 flex items-center gap-2">
              <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
              </svg>
              <span>
                Showing results from all stages
                {providerListMessage && <span className="text-blue-600"> · {providerListMessage}</span>}
              </span>
            </div>
