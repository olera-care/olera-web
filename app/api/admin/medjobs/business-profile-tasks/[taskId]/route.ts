...
/**
 * v9.0 Phase 7 Commit B: PATCH a business_profile_task.
 *
 *   { action: "complete" }  → status=completed, completed_at=now, completed_by=user
 *   { action: "cancel"   }  → status=cancelled
 *   { action: "edit", summary } → update payload.summary on a still-pending task
 */
