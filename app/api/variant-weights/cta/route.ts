...
import { getCTAVariantWeights } from "@/lib/analytics/cta-variant-weights";

// Public read endpoint for the live CTA variant weights. No auth —
// the data is non-sensitive (per-variant percentages + a version int)
// and the client-side variant assignment in useCTAVariant needs it
