 ...
 *
 * Matches staffing-outreach patterns:
 * - Tab navigation with counts
 * - City dropdown filter
 * - Search bar
 * - Provider list with click-to-view drawer
 * - Start Sequences action
 *
 * Simplified flow:
 * 1. To Send - unclaimed providers not yet contacted
 * 2. Sent - sequence in progress (email 1 → wait → email 2)
 * 3. Claimed - providers who completed their profile
 * 4. Needs Follow-up - no response after sequence
 */
...
export default function ColdOutreachAdminPage() {
  ...
  const allSelected =
    selectedIds.size === contactableProviders.length && contactableProviders.length > 0;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <p className="ml-auto text-sm text-gray-500">
          <span className="font-medium text-gray-700">{data?.total ?? 0}</span> providers
        </p>
      </div>
      ...
      <div className="flex items-center justify-between gap-4 mb-6">
        ...
        {/* Send button - only show on To Send tab with selections */}
              ...
              return (
                <li key={row.id}>
                  ...
                  >
                    ...
                    {/* Engagement signals - only on Sent tab */}
                    {stage === "sent" && (
                      <div className="flex items-center gap-1">
                        {row.email1_opened && (
                          <span className="text-sky-500" title="Email opened">👁</span>
                        )}
                        {row.email2_sent_at && (
                          <span className="text-gray-400" title="Email 2 sent">✉️</span>
                        )}
                        {row.email2_opened && (
                          <span className="text-purple-500" title="Email 2 opened">👁</span>
                        )}
                      </div>
                    )}
      ...
      <div className="mt-6 p-3 bg-amber-50 border border-amber-200 rounded-lg">
        <p className="text-[13px] text-amber-800">
          <span className="font-medium">Demo:</span> This page uses real provider data.
          Outreach status is simulated. No actual emails are sent.
        </p>
      </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="rounded-xl bg-blue-50 p-4">
                  ...
                  <p className="mt-1 text-3xl font-bold text-blue-700">{selectedIds.size}</p>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 p-4 mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Email 1 sent from Logan</p>
                      <p className="text-xs text-gray-500">Shows their profile view count + CTA</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Providers move to Sent tab</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Then move to Claimed or Needs Follow-up</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    &ldquo;Families are looking at your listing on Olera. Your profile had <strong>X views</strong> this month...&rdquo;
                  </p>
                </div>
              </div>
            </div>
...
function EmptyState({ stage }: { stage: OutreachStage }) {
  const configs: Record<OutreachStage, { icon: string; title: string; desc: string; color: string }> = {
    to_send: {
      icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
      title: "No providers to send",
      desc: "All unclaimed providers have been contacted.",
      color: "bg-blue-100 text-blue-600",
    },
    sent: {
      icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
      title: "No sequences in progress",
      desc: "Send emails from the To Send tab.",
      color: "bg-amber-100 text-amber-600",
    },
    claimed: {
      icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z",
      title: "No claimed profiles yet",
      desc: "Providers who complete their profile will appear here.",
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white py-16 text-center">
      <div className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full ${config.color}`}>
