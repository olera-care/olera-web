      ...
      <section className="relative w-full">
        ...
        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[480px]">
          ...
          <div className="absolute inset-0 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="absolute top-4 right-5 sm:right-6 lg:right-8">
              <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap items-center gap-x-3 mt-4 text-sm text-gray-500">
                {/* Rating */}
                <div className="flex items-center gap-1.5">
                  ...
                  <span>({MOCK_PROVIDER.reviewCount})</span>
                </div>
