    ...
    <main className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          {/* Breadcrumb - hidden when viewing own profile */}
          ...
          <div className="pb-8 lg:pb-10">
            <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-10">
              ...
              <div className="lg:w-[320px] lg:flex-shrink-0 space-y-5">
                ...
                {/* CTA Card (Desktop) - hidden when viewing own profile */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 lg:py-12 space-y-8 lg:space-y-12 pb-32 sm:pb-12">
        ...
        {(meta.instagram_url || meta.facebook_url || meta.tiktok_url) && (
          <section>
            ...
            <div className="flex gap-3">
              {meta.instagram_url && (
                <a href={meta.instagram_url} target="_blank" rel="noopener noreferrer" className="group w-12 h-12 rounded-xl bg-white border border-gray-200 hover:border-pink-300 hover:bg-pink-50 flex items-center justify-center transition-all duration-200" title="Instagram">
              ...
              {meta.facebook_url && (
                <a href={meta.facebook_url} target="_blank" rel="noopener noreferrer" className="group w-12 h-12 rounded-xl bg-white border border-gray-200 hover:border-blue-300 hover:bg-blue-50 flex items-center justify-center transition-all duration-200" title="Facebook">
              ...
              {meta.tiktok_url && (
                <a href={meta.tiktok_url} target="_blank" rel="noopener noreferrer" className="group w-12 h-12 rounded-xl bg-white border border-gray-200 hover:border-gray-400 hover:bg-gray-50 flex items-center justify-center transition-all duration-200" title="TikTok">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          MOBILE STICKY CTA - hidden when viewing own profile
          ═══════════════════════════════════════════════════════════════════ */}
