...
export default function PortalProfilePage() {
  ...
  // Student-only accounts — redirect to MedJobs
  if (!familyProfile && hasStudentProfile && !hasProviderProfile) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-vanilla-50 via-white to-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-gray-500 mb-6">
            This page is for family accounts. To manage your caregiver profile,
            visit your MedJobs dashboard.
          </p>
          <button
            onClick={() => router.push("/portal/medjobs")}
  ...
  // Provider-only accounts (organization/caregiver) — redirect to Provider Hub
