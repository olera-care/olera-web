...
export default async function ProviderPage({
  ...
  let images = meta?.images || (profile.image_url ? [profile.image_url] : []);
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      ...
      <div className="bg-white" data-spotlight-zone>
            ...
            <div data-spotlight-parent>
              ...
              {isMorningStar ? (
                <>
                  ...
                  {/* ── Customer Questions & Answers (shared) ── */}
                  ...
                  {/* ── Care, Daily Life, Pricing, FAQ, etc. ── */}
                  <MorningStarContent />
        ...
        {/* ===== Nearby Communities / Compare Providers ===== */}
