            ...
            <div className="flex-1 min-w-0 flex flex-col">
              ...
              {hasStaff && (
                <div className="flex items-center gap-2.5 mt-4">
                  {staff!.image ? (
                    <Image src={staff!.image} alt={staff!.name} width={28} height={28} className="w-7 h-7 aspect-square rounded-full object-cover shrink-0" />
                  ) : (
                ...
                <div id="team" className="py-8 border-t border-gray-200 scroll-mt-20">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-6">
                    <div className="border border-gray-200 rounded-xl p-5 text-center flex-shrink-0 w-40">
                      {staff!.image ? (
                        <Image src={staff!.image} alt={staff!.name} width={80} height={80} className="w-20 h-20 aspect-square rounded-full object-cover mx-auto mb-3" />
                      ) : (
