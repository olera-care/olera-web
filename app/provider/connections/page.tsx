...
function LeadDetailDrawer({
  ...
  const handleSendMessage = async () => {
    ...
    if (requireVerification && !requireVerification()) return;
...
export default function ProviderLeadsPage() {
  ...
  const { isRestricted, isPending, requireVerification, openVerificationModal } = useVerificationGate();
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-0.5 mb-2">
                      {isProviderRestricted ? (
                        <p className="text-sm text-amber-600 italic">Verify to view contact</p>
                      ) : (
                        <>
              ...
              <div className="hidden lg:grid grid-cols-[2fr_1.5fr_1fr_1fr_0.8fr_0.8fr] gap-6 items-center px-8 py-5">
                ...
                <span className="text-[14px] text-gray-600 truncate">
                  {isProviderRestricted ? <span className="text-amber-600 italic">Verify</span> : (lead.email || "—")}
                </span>

                {/* Phone */}
                <span className="text-[14px] text-gray-600 truncate">
                  {isProviderRestricted ? <span className="text-amber-600 italic">Verify</span> : (lead.phone || "Via inbox")}
                </span>
      ...
      <LeadDetailDrawer
        ...
        hideContactInfo={isProviderRestricted}
