      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Every Waiver, One Place",
                description:
                  "All HCBS, Medicaid, and long-term care programs consolidated from fragmented government sources.",
                icon: (
              ...
              <div key={item.title} className="p-6 rounded-xl bg-vanilla-100">
