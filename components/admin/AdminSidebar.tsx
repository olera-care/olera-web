...
const navItems: NavItem[] = [
  ...
  { label: "Claims", href: "/admin/providers", icon: icons.providers },
  { label: "Verification", href: "/admin/verification", icon: icons.verification },
  { label: "Directory", href: "/admin/directory", icon: icons.directory },
  { label: "Content", href: "/admin/content", icon: icons.content },
  { label: "Images", href: "/admin/images", icon: icons.images },
  { label: "Reviews", href: "/admin/reviews", icon: icons.reviews },
  { label: "Questions", href: "/admin/questions", icon: icons.questions },
  { label: "Leads", href: "/admin/leads", icon: icons.leads },
  { label: "Removals", href: "/admin/removal-requests", icon: icons.removals },
  { label: "Matches", href: "/admin/matches", icon: icons.matches },
  { label: "Care Seekers", href: "/admin/care-seekers", icon: icons.careSeekers },
  { label: "MedJobs", href: "/admin/medjobs", icon: icons.medjobs },
