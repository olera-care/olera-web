      ...
      <div className="mx-auto max-w-xl px-5 py-8 sm:py-12">
        ...
        {firstStep ? (
          <section className="mt-5 rounded-2xl bg-[#33261e] p-6 text-[#f7f3ee] shadow-sm">
            ...
            {savingsLine(firstStep.savingsRange || undefined) && (
              <p className="mt-1 text-[14px] font-semibold text-emerald-300">
                Typically {firstStep.savingsRange}
              </p>
            )}
            <p className="mt-3 text-[14px] leading-relaxed text-[#d8ccc0]">
              One phone call starts it, about ten minutes. {firstStep.contact.label}
              {firstStep.contact.hours ? ` (${firstStep.contact.hours})` : ""}.
            </p>
            <a
              href={phoneHref}
            ...
            {callScript && (
              <p className="mt-4 border-l-2 border-[#c9b8a8] pl-3 text-[13px] leading-relaxed text-[#d8ccc0]">
                What to say: &ldquo;{callScript}&rdquo;
              </p>
            )}
            {firstStep.documents.length > 0 && (
              <div className="mt-4">
                <p className="text-[12px] font-semibold uppercase tracking-[0.08em] text-[#c9b8a8]">
                  Have these nearby, if you can
                </p>
                <ul className="mt-1.5 space-y-1">
                  {firstStep.documents.map((d) => (
                    <li key={d} className="text-[13px] leading-relaxed text-[#e8e0d6]">
                      &#10003;&nbsp; {d}
                    </li>
                  ))}
                </ul>
            ...
            <Link
              ...
              className="mt-4 inline-block text-[13px] font-semibold text-[#c9b8a8] underline underline-offset-2"
            >
