    ...
    <div className="flex flex-col min-h-[calc(100vh-10rem)]">
      ...
      {pageState === "results" && (
        <div className="mt-5 flex flex-col gap-1">
          <button
            onClick={() => goToStep(0)}
            className="w-full text-sm font-medium text-gray-500 hover:text-gray-900 rounded-lg py-2 min-h-[44px] transition-colors cursor-pointer bg-transparent border-none text-left"
