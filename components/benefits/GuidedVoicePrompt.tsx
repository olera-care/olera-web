...
const GUIDED_PROMPTS: Record<IntakeStep, string> = {
  ...
  4: "To match the right programs, roughly what\u2019s the monthly income of the person who needs care? Just their own income, like Social Security or a pension. You can also say \u201Cprefer not to say.\u201D",
