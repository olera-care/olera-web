    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:mr-[45%]">
        ...
        <div className="px-4 sm:px-6 lg:pl-8 lg:pr-6 py-6">
          ...
          {/* Provider Cards — single column list */}
          {isLoadingProviders ? (
            <div className="flex flex-col gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="flex flex-row bg-white rounded-xl overflow-hidden border border-gray-200 animate-pulse"
                >
                  <div className="w-[180px] sm:w-[200px] flex-shrink-0 bg-gray-200" />
