    ...
    >
      {!isComplete ? (
        ...
        <div className="space-y-2">
          ...
          {hasResume && (
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-primary-50 flex items-center justify-center shrink-0">
                <svg className="w-[18px] h-[18px] text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="w-5 h-5 rounded-full bg-primary-100 flex items-center justify-center shrink-0">
                <svg className="w-3 h-3 text-primary-600" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
          ...
          {hasLinkedin && (
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-[#0A66C2]/10 flex items-center justify-center shrink-0">
          ...
          {(!hasResume || !hasLinkedin) && (
            <p className="text-xs text-gray-400 pt-1">
              {!hasResume ? "Tip: Adding a resume helps providers learn more about you." : "Tip: Adding LinkedIn makes your profile more credible."}
            </p>
          )}
        </div>
      )}
