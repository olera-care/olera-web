    ...
    <section className="py-16 md:py-24 bg-primary-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="relative aspect-[16/9] rounded-2xl bg-gray-200 overflow-hidden flex items-center justify-center cursor-pointer group">
            <span className="text-gray-400 text-text-sm">
              Video thumbnail — elderly man smiling
            </span>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <span className="absolute bottom-4 left-4 text-white text-text-sm font-medium bg-black/40 rounded-full px-3 py-1">
                Watch a Video
              </span>
            </div>
          </div>
