...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Getting started on Olera is free. You can claim or create your profile, add your services and photos, respond to inquiries, and start appearing in search results at no cost.",
  },
  {
