    ...
    <div ref={dropdownRef} className="relative">
      <button
        ...
        className={`
          ...
          text-left text-[15px] transition-all
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 top-full mt-1.5 bg-white rounded-xl shadow-lg border border-gray-200 py-1.5 z-50 max-h-[240px] overflow-y-auto">
          {options.map((opt) => (
            <button
              key={opt.value}
              type="button"
              ...
              className={`
                w-full px-4 py-2.5 text-left text-[15px] transition-colors
                ${opt.value === value
...
export default function QuickScheduleModal({
    ...
    <div className="pt-2 pb-4">
      ...
      <div className="flex items-center gap-3 mb-8">
        {candidate.imageUrl ? (
          ...
          <div className="w-13 h-13 rounded-full bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center ring-2 ring-white shadow-sm">
        ...
        <div className="min-w-0">
          <p className="font-semibold text-gray-900 text-[17px]">{candidate.displayName}</p>
      ...
      <div className="mt-6">
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-[15px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
        />
      </div>
      ...
      <div className="mt-8">
        <button
          ...
          className="w-full py-3.5 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-100 disabled:text-gray-400 rounded-xl text-[15px] font-semibold text-white transition-colors"
        >
          Continue
        </button>
      </div>
  ...
  const renderInfoStep = () => (
    <div className="pt-2 pb-4">
      {/* Summary pill */}
      <div className="flex items-center gap-2.5 mb-8 px-4 py-3 bg-gray-50 rounded-xl text-[15px]">
      ...
      {error && (
        <div className="mt-5 p-3.5 bg-red-50 border border-red-100 rounded-xl text-sm text-red-700">
          {error}
        </div>
      )}
      ...
      <div className="mt-7 grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            placeholder="Jane"
            className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-[15px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2.5">
      ...
      <div className="mt-5">
        ...
        <div ref={cityDropdownRef} className="relative">
          ...
          {showCityDropdown && cityResults.length > 0 && (
            <div className="absolute left-0 right-0 top-full mt-1.5 bg-white rounded-xl shadow-lg border border-gray-200 py-1.5 z-50 max-h-[200px] overflow-y-auto">
              {cityResults.map((c) => (
                <button
                  key={`${c.city}-${c.state}`}
                  type="button"
                  onClick={() => handleCitySelect(c.city, c.state)}
                  className="flex items-center gap-2.5 w-full px-4 py-2.5 text-left text-[15px] hover:bg-gray-50 transition-colors"
                >
                  <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mt-4 text-center">
        <button
          type="button"
          onClick={handleBack}
          className="text-[15px] text-gray-500 hover:text-gray-700 transition-colors"
        >
          Back
        </button>
      </div>
  ...
  const renderConfirmation = () => (
    <div className="py-6 text-center">
      ...
      <p className="mt-2 text-[15px] text-gray-500 max-w-[300px] mx-auto">
      ...
      <div className="mt-8">
        <button
          type="button"
          onClick={handleClose}
          className="w-full py-3.5 bg-gray-100 hover:bg-gray-200 rounded-xl text-[15px] font-semibold text-gray-900 transition-colors"
        >
          Done
        </button>
      </div>
