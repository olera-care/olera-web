    ...
    <div className="flex h-[calc(100vh-64px)]">
      ...
      {!isExpanded && (
        ...
        >
          {/* Mobile back button */}
          {hasSelection && (
            <div className="lg:hidden sticky top-0 z-10 bg-white border-b border-gray-100 px-2 py-1.5">
              <button
                type="button"
                onClick={onBack}
                className="flex items-center gap-1 min-h-[44px] px-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
              >
