...
export interface AccommodationsSectionProps {
  ...
  /** Custom label for shared features section (default: "{sharedFeaturesLabel}") */
  sharedFeaturesLabel?: string;
...
export default function AccommodationsSection({
  ...
  sharedFeaturesLabel = "{sharedFeaturesLabel}",
  description,
  overallPriceRange,
  disclaimer,
  providerName,
      ...
      <div>
          ...
          <div>
            ...
            {sharedFeatures.length > 0 && (
              <div className="mb-5">
                ...
                <h4 className="text-base font-semibold text-gray-800 mb-3">{sharedFeaturesLabel}</h4>
        ...
        {!hasFloorPlans && (
          <>
            {sharedFeatures.length > 0 && (
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-gray-700 mb-3">{sharedFeaturesLabel}</h3>
