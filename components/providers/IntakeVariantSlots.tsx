 ...
 *   20% inline_answer   →   see inline Q&A answer expansion with email capture
 *
 ...
 * "outreach" or "inline_answer". 40% of visitors see a brief flash of
 * BenefitsDiscoveryModule disappearing. The other 60% see no change. Trade
 * chosen to preserve first-paint UX for the majority arms.
 */
