    ...
    >
      ...
      {view === "choice" && (
        <div className="pt-2 pb-4">
          ...
          {/* CASE 2: Claimed + NOT Owner → Sign in (primary) + Dispute (secondary) */}
          {isClaimed && !isOwner && (
            <div className="rounded-2xl border border-primary-100 bg-primary-50/60 p-6">
              ...
              {/* Secondary - dispute link */}
              <button
                type="button"
                onClick={handleDisputeClick}
                className="w-full mt-3 text-sm text-gray-500 hover:text-gray-700 transition-colors text-center"
              >
