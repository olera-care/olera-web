...
export default function ServiceAreaSection({ center, areas, providerName, regionLabel }: ServiceAreaSectionProps) {
  ...
  const displayRegion = regionLabel || `${areas.length} communities`;
