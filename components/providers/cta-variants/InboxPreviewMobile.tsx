...
interface InboxPreviewMobileProps {
  providerId: string;
  providerName: string;
  providerSlug: string;
...
/**
 * Full-screen mobile component for Step 2 of the inbox_preview variant.
 * Shows the inbox preview with email capture in a mobile-optimized layout.
 */
export default function InboxPreviewMobile({
  providerId,
  providerName,
  providerSlug,
  providerCategory,
    ...
    try {
      ...
      if (data.accessToken && data.refreshToken) {
        ...
        supabase.auth.setSession({
          ...
          console.error("[inbox-preview-mobile] Session error:", err);
        });
      }
      ...
      const msg =
        err && typeof err === "object" && "message" in err
          ...
          : String(err);
      console.error("[inbox-preview-mobile] Submit error:", msg);
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      {/* Footer */}
      <div
        className="px-4 pt-4 pb-4 bg-gray-50 border-t border-gray-100"
