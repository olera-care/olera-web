...
export default function Navbar() {
  ...
  const isProviderPortal =
    ...
    pathname.startsWith("/provider/market") ||
                        ...
                        {mobileAccordion === "hub" && (
                          <div className="mt-1 space-y-0.5">
                            {([
                              ...
                              { label: "Families hiring", href: "/portal/medjobs/jobs", match: "/portal/medjobs/jobs", icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 0H8m8 0h2a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2h2" },
