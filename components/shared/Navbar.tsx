...
export default function Navbar() {
  ...
  const profileTypeLabel = contextProfileType
    ? contextProfileType === "organization"
      ...
      : "Family"
    : null;
  const isProviderCaregiver = contextProfileType === "caregiver";
          ...
          <div className="flex items-center h-16">
            ...
            {!isMinimalNav && (
              <div className="hidden lg:flex items-center gap-1">
                {isProviderPortal ? (
                  /* Provider Hub nav links — role-aware */
                  <>
                    {(isProviderCaregiver
                      ? [
                          ...
                          { label: "Find Jobs", href: "/portal/discover/providers", match: "/portal/discover/providers", badge: 0 },
                          ...
                          <div className="mt-1 space-y-0.5">
                            {(isProviderCaregiver
                              ? [
                                  ...
                                  { label: "Find Jobs", href: "/portal/discover/providers", match: "/portal/discover/providers", badge: 0, icon: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" },
                        ...
                        {mobileAccordion === "discover" && (
                          <div className="mt-1 space-y-0.5">
                            ...
                            <Link
                              ...
                              className={`flex items-center gap-3 py-2.5 px-3 rounded-lg transition-colors ${pathname === "/browse/caregivers" ? "bg-secondary-50 text-secondary-600" : "text-gray-600 hover:bg-gray-50"}`}
                              onClick={() => {
                                if (hasFamilyProfile && familyProfileId) switchProfile(familyProfileId);
                                setIsMobileMenuOpen(false);
                              }}
