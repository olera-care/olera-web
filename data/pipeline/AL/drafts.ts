...
export const drafts: PipelineStateDrafts = {
  ...
  "programs": [
    ...
    },
    {
      ...
      "applicationGuide": {
        "method": "mail",
        "summary": "Alabama has no online application for this. You fill in Form 211 and send it with proof of income.",
        "steps": [
          {
            "step": 1,
            "title": "Get Form 211",
            "description": "Download it from medicaid.alabama.gov, or call (800) 362-1504 and follow the prompts to have one mailed to you. They will ask for your name, mailing address, and Social Security number."
          },
          {
            "step": 2,
            "title": "Fill it in and sign it",
            "description": "An unsigned form cannot be processed."
          },
          {
            "step": 3,
            "title": "Send it with proof of income",
            "description": "Include a recent check stub or award letter showing gross monthly income before taxes. Email to apply@medicaid.alabama.gov, or mail it to the Medicaid District Office for your county."
          },
          {
            "step": 4,
            "title": "If you do not have free Part A",
            "description": "Apply for Conditional Part A at your local Social Security office between January and March, or in the month before, of, or after your 65th birthday."
          }
        ],
        ...
        "urls": [
          {
            "label": "Form 211, the application",
            "url": "https://medicaid.alabama.gov/documents/9.0_Resources/9.4_Forms_Library/9.4.1_Applicant-Recipient_Forms/9.4.1_Form_211_MSP_10-20.pdf"
          },
          {
            "label": "Help paying for Medicare page",
            "url": "https://medicaid.alabama.gov/content/3.0_Apply/3.2_Qualifying/3.2.6_Help_Paying_Medicare.aspx"
          },
          {
            "label": "Find your Medicaid District Office",
            "url": "https://medicaid.alabama.gov/content/10.0_Contact/10.1_Medicaid_Contacts/10.1.1_Medicaid_Locations.aspx"
          }
        ]
      },
      "documentsNeeded": [
        "Proof of gross monthly income before taxes, such as a recent check stub or Social Security award letter. This has to go in with the form.",
        "The completed and signed Form 211.",
        "The Medicare card, for the numbers the form asks for.",
      ...
      "contacts": [
        {
          ...
          "description": "Follow the prompts to have a Form 211 mailed to you. This line cannot take or decide an application.",
