...
export const drafts: PipelineStateDrafts = {
  ...
  "programs": [
    ...
    },
    {
      ...
      "name": "Arizona PACE (Program of All-Inclusive Care for the Elderly)",
      "shortName": "Arizona PACE",
      "tagline": "All-in-one medical care and daily support for parents who need nursing home level care but want to stay home.",
      "programType": "benefit",
      "complexity": "deep",
      "geographicScope": {
        "type": "local",
        ...
        "localEntities": [
          {
            "name": "PACE service areas in Arizona",
            "type": "service-area"
          }
        ]
      },
      ...
      "structuredEligibility": {
        ...
        "functionalRequirement": "Must be certified by AHCCCS as needing nursing home level of care (requires daily assistance with activities like bathing, dressing, eating, medication management, or mobility)",
        "otherRequirements": [
          "Live in a PACE organization service area",
          "Able to live safely in the community with PACE services",
          "Cannot be enrolled in Medicare Advantage, hospice, or Medicare prescription drug plans",
          "Must agree to receive all care through PACE team only"
        ],
        "povertyLevelReference": null
      },
      "applicationGuide": {
        "method": "phone",
        "summary": "Call the AHCCCS helpline at (877) 382-2363 to start the nursing home certification process, then contact your local PACE organization.",
        "steps": [
          {
            "step": 1,
          ...
          },
          {
            ...
            "description": "Once you confirm PACE availability in your area, contact that specific PACE center directly. Each organization handles its own enrollment and has different wait times."
          },
          {
            "step": 4,
      ...
      "documentsNeeded": [
        ...
        "Proof of Arizona residency (utility bill, lease agreement, or state ID)",
        "Complete list of current medications with dosages",
        "Recent medical records and hospital discharge summaries",
        "Contact information for all current doctors and specialists",
        "Insurance cards for any supplemental coverage",
        "Bank statements for all accounts (last 3 months)",
        "Income documentation (Social Security, pension, retirement statements)",
        "Property documents if applying for ALTCS coverage",
        "Legal documents for power of attorney or guardianship if applicable"
      ],
      "contacts": [
        {
          "label": "AHCCCS Helpline",
          "phone": "(877) 382-2363",
          "description": "Arizona Medicaid agency for nursing home certification",
          "hours": "Business hours"
        },
        {
          "label": "National PACE Association",
          "phone": null,
          "description": "Find local PACE organizations at npaonline.org",
          "hours": null
        }
      ],
      "applicationNotes": [
