...
export const drafts: PipelineStateDrafts = {
  ...
  "programs": [
    ...
    },
    {
      ...
      "savingsRange": "$553/year on average in 2026",
      "savingsSource": "Delaware LIHEAP heating assistance grants average $553/year; individual awards vary with income, household size, and fuel cost",
      "savingsVerified": true,
      "structuredEligibility": {
        "summary": [
