  ...
  "programs": [
    {
      ...
      "applicationGuide": {
        ...
        "urls": [
          ...
          {
            "label": "Apply for Elderly and Disabled Waiver",
    ...
    },
    {
      ...
      "applicationGuide": {
        "method": "phone",
        "summary": "Call to request an application by mail, no office visits or face-to-face interviews required.",
        "steps": [
          {
            "step": 1,
            "title": "Request application",
            "description": "Call (404) 370-6236 to request a Senior SNAP application be mailed to you, or email seniorsnap@dhr.state.ga.us"
          },
          {
            "step": 2,
            "title": "Complete and return",
            "description": "Fill out the mailed application and return it to Georgia DFCS at the address provided with your application packet"
          },
          {
            "step": 3,
            "title": "Provide documents",
            "description": "Submit required verification documents, fixed income is often auto-verified through computer matches, so minimal paperwork may be needed"
          }
        ],
        "processingTime": null,
        "waitlist": null,
      ...
      "contacts": [
        {
          "label": "Georgia 2-1-1",
          "phone": "2-1-1",
          "description": "Statewide helpline for all social services and local CAA contact information",
          "hours": "24 hours, 7 days a week"
        },
        {
          "label": "Georgia DFCS",
          "phone": null,
          "description": "Visit dfcs.georgia.gov for complete list of county Community Action Agencies",
    ...
    },
    {
      ...
      "structuredEligibility": {
        ...
        "functionalRequirement": null,
        "otherRequirements": [
          "Must live in single-family home or manufactured home (campers and non-stationary trailers ineligible)",
