 ...
 *
 * Last updated: 2026-08-23T07:26:45.385Z
 */
  ...
  "programs": [
    ...
    },
    {
      ...
      "applicationNotes": [
        ...
        "MAC is built around an unpaid caregiver, so spouses are not paid for the care they give under this waiver. That is the trade: the caregiver stays unpaid and the state funds support services around them. If you need to be paid for the care itself, ask about Washington's other Medicaid personal care options instead of MAC."
      ],
      "relatedPrograms": [
        "COPES Waiver",
