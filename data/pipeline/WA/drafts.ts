...
export const drafts: PipelineStateDrafts = {
  ...
  "programs": [
    ...
    },
    {
      ...
      "contacts": [
        {
          "label": "Community Living Connections",
          "phone": "1-855-567-0252",
          "hours": "Mon-Fri business hours"
        }
      ],
      "applicationNotes": [
        "Washington has paused new enrollment in MAC and put a statewide waitlist in place, and the state has not set a date to reopen it. You can still call. Ask to talk through your options and to be added to the waitlist. Confirm the current status on that call, because this can change.",
        "Your first call is a needs and level-of-care screen, not a financial review. Financial paperwork comes later. When you do apply you sign a form letting the state pull your bank records electronically, at no cost to you, so you may never be asked for statements at all. If the office needs something specific it sends a written list with a due date.",
