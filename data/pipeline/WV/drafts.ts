...
export const drafts: PipelineStateDrafts = {
  ...
  "programs": [
    ...
    },
    {
        ...
        "steps": [
          {
            ...
            "description": "Look up your county's agency at wvcad.org or call examples like CASEWV (casewv.org), MountainHeart (304-682-8271 ext. 101 or 117 for Wyoming/Fayette Counties), or Southwestern Community Action Council (scacwv.org)."
          },
          {
            "step": 2,
      ...
      "documentsNeeded": [
        "Valid government-issued photo ID for applicant",
        "Written proof of all gross income from prior year (tax returns, Social Security award letters, pension statements)",
      ...
      "contacts": [
        {
          "label": "West Virginia Community Action Directory",
          "phone": null,
          "description": "Find your county's weatherization agency",
          "hours": "Visit wvcad.org"
        },
        {
          "label": "MountainHeart (Wyoming/Fayette Counties)",
          "phone": "(304) 682-8271",
          "description": "Weatherization services for Wyoming and Fayette Counties (ext. 101 or 117)",
          "hours": "Business hours"
        },
        {
          "label": "West Virginia 2-1-1",
