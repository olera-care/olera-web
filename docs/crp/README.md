...
| `Olera_Pre_CRP_RD_Commercialization_and_Execution_Plan.pdf` / `.docx` | **The pre-CRP plan**, ten sections: purpose, the care-establishment pathway (Table 1), the R&D and commercialization roadmap, provider commercialization, CareNavigator development, institutional-buyer development, private investors, the January readiness scorecard of eight risks, the eighteen-week plan to submission, and the January end state | Logan's draft of 2026-09-02; house-style build in `passes/pre-crp-v2-src/` | live; governs the September to January window |
