...
medications, and moving safely through the home. Most families meet that moment at its worst,
after a fall or a sudden hospitalization, and are expected to become experts in eldercare
overnight.</p>

<p>A recognized need becomes established care only if a family clears three gates (Figure 1).
They must <b>find</b> the right care across four systems with separate eligibility rules and no
party accountable for whether care begins. They must <b>afford</b> it: full-time home care runs
$80,080 a year,<sup>@genworth</sup> Medicare does not cover custodial home care, Medicaid pays
only after a family has spent down, and an estimated $58 billion in assistance goes unclaimed
every year because families cannot navigate the programs.<sup>@ncoa2025</sup> And someone must
...
Nearly a third of older adults with difficulty in activities of daily living go without
bathing, meals, or medications in a given month,<sup>@freedmanSpillman2014</sup> and unmet
...
<p class="sec"><b>Where the money already goes.</b> Demand is rising while both sources of
supply contract (Figure 2), and the paid workforce that would have to absorb the difference
faces 9.7 million direct-care job openings between 2024 and 2034.<sup>@phi2025</sup></p>

<p>The cost of that shortfall is already being paid, just not where anyone planned. Family
caregiving costs working Americans $107 billion a year in earnings they do not make, and
...
hard part. A family has to work out which aid program applies, which insurance benefit applies, and which service or provider is needed, then complete the same administrative sequence for each: applications, documentation, intake, scheduling, waiting for
a response, answering follow-up requests, confirming provider availability, securing approval,
and confirming that care began. Families are lost to follow-up somewhere in that sequence, and existing help stops earlier. A discharge planner hands over a printed list and the case closes
at the hospital door; information services return directories; referral marketplaces introduce
a provider and are paid on placement. None is accountable for whether care was established,
and even where navigation succeeds there may be no capacity in the local market to deliver
it.</p>
...
<p>CareNavigator is an eldercare AI navigation system built over an expert-curated national
database of aid programs and providers, developed across NIA SBIR Phases I through IIB. It screens a household's needs and means and returns a care and funding plan with the steps required to obtain each resource (Figure 3). What this award adds is execution: agents
that carry those steps out, follow up on a schedule, and confirm the date aid or care began.
...
family connection.</b> Nothing about a family's access depends on who has paid, which removes the gating on who can be helped, keeps the network from tilting toward whoever bought placement, and leaves no incentive to steer anyone. It also lets federally
reimbursed providers participate, which pay-per-referral models cannot accommodate.
<b>Caregiver Staffing is the product sold and priced during this award.</b></p>

<p class="sec"><b>Market segments and customers.</b> The beachhead customer for our staffing
product is healthcare and long-term services and supports providers, of which roughly 165,000
operate in the United States.<sup>@nhe2023,@cdcNpals2020</sup> The published median cost of
...
develop products for it. The organizations named above bear the cost when care does not get
established, in avoidable emergency visits, readmissions, premature institutionalization, and
caregivers who break down, and Medicare now pays directly for care navigation through the
GUIDE model.<sup>@cmsGuide2024</sup> Evidence that care was established, paired with defensible estimates of the utilization it avoids, is what makes that proposition real. The
Commercialization Plan models both this and the staffing beachhead; at modeled steady state a
single market carries about 50 paying provider accounts and $165,000 in annual recurring
revenue against roughly $30,000 to enter it, with lifetime value above four times acquisition
cost.</p>

<p class="sec"><b>Competitive environment and our advantage.</b> Table 2 places our two
products against every category of alternative across the path a family travels. Every
alternative solves only part of it, and families can still fall through before care is
established.</p>
...
the path than any product does. They are also scarce, and the constraint cannot be solved by hiring: healthcare social workers are projected to grow six percent between 2024 and 2034, about 13,600 positions, against a population over 65 growing far faster.<sup>@blsSocialWork2025</sup> The closest commercial analogues are the navigation
platforms sold to employers and health plans, where access depends on who employs or insures a
family.<sup>@navPlatforms2026</sup> On the staffing side the distinction is simpler: agencies, job boards, and gig platforms compete only for workers already in the direct-care pool. <b>Olera builds the pathways and infrastructure that bring new people into caregiving,</b> which is the subject of Key Innovation 1.</p>
...
<p>The causes of the caregiver shortage are equally well documented and largely economic:
median annual earnings for direct-care workers are just under $26,000,<sup>@phi2025</sup>
the work is demanding, career ladders are short, and median turnover in home care runs near
75 percent a year.<sup>@caregiverCAC2025</sup> Both the literature and the industry response
concentrate on retaining and competing for the workers already in the field. Comparatively
little has addressed enlarging the labor pool itself by building infrastructure that brings
new people into caregiving, which is the gap Key Innovation 1 addresses.</p>
...
they love, and acceptance research finds willingness that is real but conditional: among 199 family caregivers surveyed, 62 percent intended to use AI-enabled care technology, with trust and perceived cost among the significant predictors.<sup>@yee2025</sup> We answer trust with verification rather than assurance, so
every answer comes from a database audited by a blinded expert panel in Aim 1 and acceptance
is measured under IRB approval in Aim 2; we answer cost by charging families nothing.</p>
...
<p>That infrastructure is the innovation, not the recruiting. It is a technical pathway carrying a person with no eldercare experience through online training, screening, identity and credential verification, placement with a licensed employer, and supervised work, and issuing <b>a verified, longitudinal record of their caregiving experience</b>: hours
worked, employers, training completed, competencies demonstrated, populations served
including dementia care, supervisor evaluations, reliability, background checks, and
references. That record travels with the worker. Nothing like it exists today, so a caregiver who changes employers starts over and is re-screened on work already verified. The
...
the agents execute. A case runs from a detected need through eligibility and funding, a plan, the administrative work it requires, a provider with capacity, a caregiver to fill it, confirmed care, and what happened after. <b>The unit of success changes
from information delivered to care established.</b> That makes the outcome measurable, makes it saleable to an organization bearing the cost of unmet need, and makes the system improve, since every completed case becomes supervised training data for the next.</p>
...
<p>Beneath that sit local program realities and provider truths that were never published:
which office actually processes an application, what a program requires in practice rather than
on its form, which providers take which payment sources, and which have capacity. We assembled
that layer through field work, expert curation, and direct outreach, into more than 72,000
records covering all fifty states.</p>
...
<p>Execution is what produces that layer, and it compounds: more families produce more
executed cases, which produce more observed rules, capacity, and outcomes, which produce
better navigation, which establishes care for more families. <b>What this project builds is
the first longitudinal, county-level administrative record of what older adults need, what
they qualify for, where the system fails them, and whether care was established.</b> A
competitor who copies every feature begins with an empty database. The measurement also exists
nowhere else, for researchers or for the state agencies that plan around it, and we commit to
publishing from it.</p>
"""
