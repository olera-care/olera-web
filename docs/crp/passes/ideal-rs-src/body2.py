...
<p class="sec"><b>Task 2.2: Recruit, place, and retain caregivers.</b> Table 3 also lists the workforce channels. Prior direct-care employment is ascertained at intake, so the share new to the field is measured rather than inferred, and each placement is timestamped from application to first confirmed shift, giving time to hire and fill rate. Retention is reported by cohort at 90 days, separately for workers who stay with the placing provider and those who move to another licensed employer carrying their record, because a worker who changes employers still represents capacity added. <b>The month 21 gate requires half of the Aim 2 placements still in direct care at 90 days.</b></p>
