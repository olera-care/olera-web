...
<tbody>
<tr><td><b>Technical</b><br>Could the data be assembled?</td><td>NIA Phase I to IIB</td><td>An expert-curated national database of more than 72,000 aid programs and providers across all fifty states, and a multi-agent eldercare AI entering production.</td></tr>
<tr><td><b>User</b><br>Would families accept it?</td><td>NIA Phase I to IIB</td><td>Four peer-reviewed evaluations with family caregivers: usability 4.57 of 5; acceptance 5.83 of 7 after four weeks (n = 65); multi-agent version 5.73 of 7 (n = 31).</td></tr>
<tr><td><b>Demand</b><br>Would families come, and at what cost?</td><td>Beyond Phase II scope; company funds</td><td>Organic traffic grew from roughly 50 visits a day in 2023 to more than 500 today, from nearly every county, at near-zero cost.</td></tr>
<tr><td><b>Supply</b><br>Would providers participate?</td><td>I-Corps and company funds</td><td>More than 300 customer-discovery conversations with owners and operators through NIH and NSF I-Corps; more than 700 providers have since claimed a listing at no charge.</td></tr>
<tr><td><b>Workforce and willingness to pay</b><br>Could we recruit caregivers, and would anyone pay?</td><td>Beyond Phase II scope; company funds</td><td>A student caregiver pilot drew more than 900 applicants and placed more than 20 into provider jobs. Four providers trialed the staffing product and three paid, at roughly $50 to $275 per placement and $275 per month, across multiple semesters. Manual delivery capped scale.</td></tr>
