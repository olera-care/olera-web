...
<tbody>
<tr><td><b>Technical</b><br>Could the data be assembled?</td><td>NIA Phase I to IIB</td><td>An expert-curated national database of more than 72,000 aid programs and providers across all fifty states, and a multi-agent eldercare AI that runs on it, now entering production integration.</td></tr>
<tr><td><b>User</b><br>Would families accept it?</td><td>NIA Phase I to IIB</td><td>Four peer-reviewed evaluations with family caregivers: usability 4.57 of 5; technology acceptance 5.83 of 7 after four weeks of independent use (n = 65); multi-agent version 5.73 of 7 (n = 31, in preparation).</td></tr>
<tr><td><b>Demand</b><br>Would families come, and at what cost?</td><td>Beyond Phase II scope; company funds</td><td>Organic traffic grew from roughly 50 visits a day in 2023 to more than 500 today, about 15,500 a month, arriving through search from nearly every county in the country at near-zero acquisition cost.</td></tr>
<tr><td><b>Supply</b><br>Would providers participate?</td><td>I-Corps and company funds</td><td>More than 300 customer-discovery conversations with owners and operators through NIH and NSF I-Corps. More than 700 providers have since claimed their listing at no charge, with roughly 150 more each month.</td></tr>
...
<tr class="rem"><td><b>The risk that remains</b><br>Can one local market pay for itself, and can we repeat it?</td><td>Not yet retired</td><td>Measurable only with real customers paying real prices over a retention window long enough to observe churn. This is the uncertainty Aims 1, 2, and 3 are designed to remove.</td></tr>
</tbody></table>
