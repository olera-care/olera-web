# -*- coding: utf-8 -*-
"""Build the house-style .docx for the Statement of Need from s8_word.html."""
import re, html as H
...
SRC = open('s8_word.html', encoding='utf-8').read()
...
doc.save('Olera_CRP_ProjectManagement.docx')
print('saved docx')
