# -*- coding: utf-8 -*-
"""Build the house-style .docx for the Pre-CRP Commercialization and Execution Plan."""
import re, html as H
...
SRC = open('pre_word.html', encoding='utf-8').read()
...
doc.save('Olera_Pre_CRP_Commercialization_and_Execution_Plan.docx')
print('saved docx')
