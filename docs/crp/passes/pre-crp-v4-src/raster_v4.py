# -*- coding: utf-8 -*-
"""Rasterize Figure 2 at 300 dpi for the Word export."""
...
subprocess.run(['/opt/pw-browsers/chromium', '--headless', '--disable-gpu',
                ...
                '--print-to-pdf=png/fig2.pdf', 'png/fig2.html'], capture_output=True)
d = pymupdf.open('png/fig2.pdf')
assert d.page_count == 1, f'figure 2 spilled to {d.page_count} pages'
d[0].get_pixmap(dpi=300).save('png/fig2.png')
print(f'  fig2: {w_in:.2f} x {h_in:.2f} in')
