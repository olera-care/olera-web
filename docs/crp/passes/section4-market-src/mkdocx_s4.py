# -*- coding: utf-8 -*-
"""Build the house-style .docx for the Statement of Need from s4_word.html."""
import re, html as H
...
SRC = open('s4_word.html', encoding='utf-8').read()
...
doc.save('Olera_CRP_Section4_Market.docx')
print('saved docx')
