# -*- coding: utf-8 -*-
"""Build the house-style .docx for the Statement of Need from son_word.html."""
import re, html as H
...
SRC = open('son_word.html', encoding='utf-8').read()
...
def add_runs(par, frag, size=None, color=None, base_bold=False):
...
doc.save('Olera_CRP_StatementOfNeed.docx')
print('saved docx')
