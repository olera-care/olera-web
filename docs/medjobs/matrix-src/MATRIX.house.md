...
**The meeting is not a gate.** It was steps 4 and 5 of the sequence; it is a branch now, reached when a provider asks to be walked through it. The rung takes the date they gave and puts the logging rung on that day rather than two days from today.
