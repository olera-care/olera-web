...
export const PROVIDER_EVENT_LABELS: Record<string, string> = {
  ...
  referral_source_viewed: "Reviewed a referral source",
  referral_call_clicked: "Tapped a referral call link",
  ...
  managed_ads_not_now: "Turned down the ads offer",
  ads_touchpoint_viewed: "Was shown the ads nudge",
  ads_touchpoint_clicked: "Tapped the ads nudge",
  ads_touchpoint_dismissed: "Dismissed the ads nudge",
