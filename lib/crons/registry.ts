...
export const CRON_REGISTRY: CronJob[] = [
  ...
  },
  {
    ...
    description: "Onboarding Email 2. Sent 48h after the verification step. Shows providers what families see on their profile and encourages them to add missing details.",
    recipientCohort: "Claimed providers who passed through the verification step 48+ hours ago.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
  ...
  },
  {
    ...
    description: "Onboarding Email 3. Sent 72h after the profile preview email. Encourages providers to turn on SMS notifications so they never miss a family inquiry.",
    recipientCohort: "Claimed providers who received the profile preview email 72+ hours ago and don't have SMS notifications enabled.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
