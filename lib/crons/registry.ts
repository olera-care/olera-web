...
export const CRON_REGISTRY: CronJob[] = [
  ...
  {
    id: "onboarding-verification-nudge",
    name: "Onboarding: Verification nudge",
    description: "Onboarding Email 1. Sent 24h after the welcome email. Nudges unverified providers to verify their page in under a minute via work email or LinkedIn.",
    recipientCohort: "Claimed, unverified providers who received the welcome email 24+ hours ago.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
    path: "/api/cron/onboarding-verification-nudge",
    emailTypes: ["onboarding_verification_nudge"],
    successSignal: "Provider completes verification.",
    relatedAdminPath: "/admin/verification",
  },
  {
    id: "onboarding-notification-setup",
    name: "Onboarding: Notification setup",
    description: "Onboarding Email 2. Sent 72h after the verification nudge. Encourages providers to turn on SMS notifications so they never miss a family inquiry.",
    recipientCohort: "Claimed providers who received the verification nudge 72+ hours ago and don't have SMS notifications enabled.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
    path: "/api/cron/notification-setup-nudge",
    emailTypes: ["notification_setup_nudge"],
    successSignal: "Provider enables SMS notifications.",
    relatedAdminPath: "/admin/verification",
  },
  {
    id: "onboarding-profile-preview",
    name: "Onboarding: Profile preview",
    description: "Onboarding Email 3. Sent 72h after the notification setup nudge. Shows providers what families see on their profile and encourages them to add missing details.",
    recipientCohort: "Claimed providers who received the notification setup nudge 72+ hours ago.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
    ...
    successSignal: "Provider visits their public profile page.",
    relatedAdminPath: "/admin/verification",
  },
  {
    id: "verification-reminders",
    name: "Verification reminders",
    description: "21-day safety-net reminder for providers who claimed but still haven't verified. The onboarding sequence handles the early nudge at +24h.",
    recipientCohort: "Claimed-but-unverified providers at 21+ days post-claim.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 14 * * *",
    humanSchedule: "Daily, 14:00 UTC (~9-10 AM ET)",
    path: "/api/cron/verification-reminders",
    emailTypes: ["verification_reminder_21d"],
    successSignal: "Provider completes verification.",
    relatedAdminPath: "/admin/verification",
  },
  {
  ...
  },
  {
    ...
    description: "Onboarding Email 0. Sent to providers shortly after they claim their page. Congratulates them on taking ownership and links to their dashboard. Sets lifecycle_stage to 'onboarding'.",
    recipientCohort: "Recently claimed providers who haven't received the welcome email yet.",
    audience: "Providers",
    fn: "nudge",
    schedule: "0 * * * *",
    humanSchedule: "Hourly, on the hour (business hours only: Mon-Fri 9am-5pm provider local)",
