...
export const EMAIL_VARIANTS: EmailVariant[] = [
  ...
  {
    id: "interview_reschedule_sent_student",
    audience: "student",
    group: "Student · Interviews",
    label: "Reschedule confirmation (student)",
    subject: `Your proposed time was sent to ${SAMPLE_MEDJOBS_PROVIDER.providerName}`,
    emailType: "interview_reschedule_sent",
    timing: "When student proposes a new interview time",
    who: "Student who just proposed a new interview time.",
    why: "Confirm that their proposed time was sent to the provider.",
    render: () => interviewRescheduleSentEmail({
      recipientName: SAMPLE_STUDENT.studentName,
      otherName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      newTime: SAMPLE_INTERVIEW.proposedTime,
      viewUrl: SAMPLE_INTERVIEW.viewUrl,
    }),
  },
  {
    id: "interview_reschedule_sent_provider",
    audience: "provider",
    group: "MedJobs · Interviews",
    label: "Reschedule confirmation (provider)",
    subject: `Your proposed time was sent to ${SAMPLE_STUDENT.studentName}`,
    emailType: "interview_reschedule_sent",
    timing: "When provider proposes a new interview time",
    who: "Provider who just proposed a new interview time.",
    why: "Confirm that their proposed time was sent to the student.",
    render: () => interviewRescheduleSentEmail({
      recipientName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      otherName: SAMPLE_STUDENT.studentName,
      newTime: SAMPLE_INTERVIEW.proposedTime,
  ...
  // ─────────────── Student · Placements ───────────────
  {
    id: "placement_offered_to_student",
    audience: "student",
    group: "Student · Placements",
    label: "Job offer received",
    subject: `${SAMPLE_MEDJOBS_PROVIDER.providerName} wants to hire you!`,
    emailType: "placement_offered",
    timing: "When provider offers to hire a student",
    who: "Student who received a job offer from a provider.",
    why: "Notify them of the job offer and drive them to accept/decline.",
    render: () => placementOfferedEmail({
      studentName: SAMPLE_STUDENT.studentName,
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      notes: "We loved meeting you and think you'd be a great fit for our team. We're offering a flexible part-time position with competitive pay.",
      viewUrl: SAMPLE_STUDENT.magicLink,
    }),
  },
  {
    id: "placement_accepted_student",
    audience: "student",
    group: "Student · Placements",
    label: "Job offer accepted (confirmation)",
    subject: `You accepted the offer from ${SAMPLE_MEDJOBS_PROVIDER.providerName}`,
    emailType: "placement_accepted_confirmation",
    timing: "When student accepts a job offer",
    who: "Student who just accepted a job offer.",
    why: "Confirm their acceptance and outline next steps.",
    render: () => placementAcceptedStudentEmail({
      studentName: SAMPLE_STUDENT.studentName,
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      viewUrl: SAMPLE_STUDENT.magicLink,
    }),
  ...
  {
    id: "placement_cancelled_student",
    audience: "student",
    group: "Student · Placements",
    label: "Job offer withdrawn",
    subject: `Offer update from ${SAMPLE_MEDJOBS_PROVIDER.providerName}`,
    emailType: "placement_cancelled",
    timing: "When provider withdraws a job offer",
    who: "Student whose job offer was withdrawn by the provider.",
    why: "Inform them the offer was cancelled and encourage them to find other opportunities.",
    render: () => placementCancelledEmail({
      studentName: SAMPLE_STUDENT.studentName,
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      viewUrl: SAMPLE_STUDENT.magicLink,
    }),
  ...
  // ─────────────── MedJobs · Placements (Provider side) ───────────────
  {
    id: "placement_accepted_provider",
    audience: "provider",
    group: "MedJobs · Placements",
    label: "Student accepted job offer",
    subject: `${SAMPLE_STUDENT.studentName} accepted your job offer!`,
    emailType: "placement_accepted",
    timing: "When student accepts a job offer",
    who: "Provider whose job offer was accepted by a student.",
    why: "Confirm the acceptance and provide next steps for onboarding.",
    render: () => placementAcceptedEmail({
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      studentName: SAMPLE_STUDENT.studentName,
      viewUrl: SAMPLE_INTERVIEW.providerViewUrl,
    }),
  ...
  {
    id: "placement_declined_provider",
    audience: "provider",
    group: "MedJobs · Placements",
    label: "Student declined job offer",
    subject: `${SAMPLE_STUDENT.studentName} declined your job offer`,
    emailType: "placement_declined",
    timing: "When student declines a job offer",
    who: "Provider whose job offer was declined by a student.",
    why: "Inform them of the decline and encourage them to find other candidates.",
    render: () => placementDeclinedEmail({
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      studentName: SAMPLE_STUDENT.studentName,
      viewUrl: SAMPLE_INTERVIEW.providerViewUrl,
    }),
