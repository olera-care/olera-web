...
export const EMAIL_VARIANTS: EmailVariant[] = [
  ...
  {
    id: "provider_profile_preview_demand", audience: "provider", group: "Provider · Onboarding",
    label: "Profile preview · families nearby", subject: "3 families near Austin are looking for care",
    emailType: "profile_preview_nudge", cron: "profile-preview-nudge",
    timing: "Day 2 · 48h after the welcome email",
    situation: "Real, counted demand within 50 miles, so the email is allowed to say so. Leads with the families rather than with the provider's own page.",
    who: "Welcomed 48+ hours ago, not yet sent this, AND at least one family with a live care post within 50 miles.",
    why: "A demand claim we can back is the strongest possible reason to go fix a thin profile.",
  ...
  {
    id: "provider_profile_preview_quiet", audience: "provider", group: "Provider · Onboarding",
    label: "Profile preview · quiet market", subject: "See what families see when they find Evergreen Home Care",
    emailType: "profile_preview_nudge", cron: "profile-preview-nudge",
    timing: "Day 2 · 48h after the welcome email",
    situation: "No family within 50 miles has a live care post, so the email makes no demand claim at all and leads with the page itself.",
    who: "Welcomed 48+ hours ago, not yet sent this, and no measurable local demand. This is the MAJORITY case — only ~189 families have an active care post nationwide.",
    why: "The predecessor email asserted 'families are searching in {city}' unconditionally. Most of the time that was not true.",
    render: () => onboardingProfilePreviewEmail({
      providerName: "Evergreen Home Care",
      providerSlug: "evergreen-home-care",
      city: "Austin",
