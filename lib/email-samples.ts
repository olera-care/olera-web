...
export const EMAIL_VARIANTS: EmailVariant[] = [
  ...
  {
    id: "student_application_sent",
    audience: "student",
    group: "Student · Applications",
    label: "Application sent",
    subject: "Application Sent!",
    emailType: "student_application_sent",
    timing: "When student applies to a provider",
    who: "Student who just submitted an application to a provider.",
    why: "Confirm the application was sent and encourage profile completion.",
  ...
  {
    id: "student_application_accepted",
    audience: "student",
    group: "Student · Applications",
    label: "Application accepted",
    subject: "Application Update",
    emailType: "student_application_response",
    timing: "When provider accepts the application",
    who: "Student whose application was accepted by a provider.",
    why: "Notify the student and explain next steps.",
  ...
  {
    id: "student_application_declined",
    audience: "student",
    group: "Student · Applications",
    label: "Application declined",
    subject: "Application Update",
    emailType: "student_application_response",
    timing: "When provider declines the application",
    who: "Student whose application was declined by a provider.",
    why: "Let them know gently and encourage them to keep applying.",
    render: () => applicationResponseEmail({
      studentName: SAMPLE_STUDENT.studentName.split(" ")[0],
      providerName: SAMPLE_MEDJOBS_PROVIDER.providerName,
      accepted: false,
