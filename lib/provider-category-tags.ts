...
const HOME_HEALTH_TAGS: CategoryTagSet = {
  tags: [
    { id: "medicare-certified", label: "Medicare-certified", icon: "shield", seoFacet: "Medicare-certified home health" },
    { id: "skilled-nursing", label: "Skilled nursing", icon: "medical", seoFacet: "home health with skilled nursing" },
    { id: "physical-therapy", label: "Physical therapy", icon: "people", seoFacet: "home health with physical therapy" },
    { id: "occupational-therapy", label: "Occupational therapy", icon: "people", seoFacet: "home health with occupational therapy" },
    { id: "speech-therapy", label: "Speech therapy", icon: "people", seoFacet: "home health with speech therapy" },
    { id: "wound-care", label: "Wound care", icon: "medical", seoFacet: "home health with wound care" },
    { id: "24-7-availability", label: "24/7 availability", icon: "clock", seoFacet: "home health with 24/7 availability" },
    { id: "post-hospital-transitional", label: "Post-hospital / transitional care", icon: "star", seoFacet: "post-hospital transitional home health" },
  ],
  defaultFeatured: ["medicare-certified", "skilled-nursing"],
};
...
const CATEGORY_TAG_REGISTRY: Record<string, CategoryTagSet> = {
  ...
  home_health_agency: HOME_HEALTH_TAGS,
  // Supabase provider_category strings
  "Memory Care": MEMORY_CARE_TAGS,
  "Home Health": HOME_HEALTH_TAGS,
};
