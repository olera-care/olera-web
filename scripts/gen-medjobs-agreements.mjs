...
const STUDENT = {
  ...
  blocks: [
    { lead: "This agreement explains how the Olera program works and what you agree to when you join. It is written for you, the student. If you ever have a question about how the program works, this is the place to find the answer. Please read it before you accept your first offer." },
    { h2: "What the program is" },
    { p: "The program is a way to get real, paid experience caring for people, and to prove that experience so you can use it on your applications to medical, nursing, PA, and other health programs. You work for a local family or agency. You earn hours. We help you track those hours, get them verified, and turn them into a credential and a stronger application." },
    { p: "Olera runs the program and keeps your records. Olera does not employ you. The family or agency you work for does. More on that below." },
    ...
    { step: { n: 2, title: "You find a job and accept an offer.", body: "Your employer is who you will work for. It is either a family who needs care for a loved one, or a care agency. You browse the families and agencies near you who are looking for help, and you can talk with them before you decide. When one wants to work with you, they send you an offer. You choose the offer you want and accept it. You are never required to accept an offer." } },
    { step: { n: 3, title: "You pay once and sign.", body: "When you accept your first offer, you pay a one-time fee of $200 and sign this agreement. This is the only fee you will ever pay. It covers the whole program, no matter how many families or agencies you work with or how many terms it takes you to finish. You only pay after a family or agency has offered you a spot and you have accepted, so you never pay for something that has not happened yet." } },
    ...
    { step: { n: 5, title: "You work your shifts.", body: "You and your employer agree on your schedule and your pay. Your employer — the family or agency you work for — sets your hours, pays you, and supervises your work. If your employer is an agency, they pay you through their payroll. If your employer is a family, they pay you directly, and Olera can help send the payment. Olera does not set your pay and does not pay you.\n\nWhile you work, you agree to:", bullets: ["show up on time, and tell your employer early if your plans change", "only do tasks you have been trained for", "keep private what you learn about the person you care for", "keep your profile up to date, so families and agencies know when you are available and who you are working with"] } },
    { step: { n: 6, title: "You log your hours, and your employer checks them.", body: "After each shift, you fill out a short report card. It lists the date, how long you worked, and what you did. Your employer reviews it and confirms it is correct. You agree to log your hours honestly. This step is what turns the time you worked into hours you can prove." } },
    { step: { n: 7, title: "Your hours add up and stay yours.", body: "Olera keeps a running total of the hours your employers have confirmed. You can see your total at any time. Your confirmed hours belong to you. They stay yours even if you stop working with one employer or move to a new one.\n\nIf an employer does not confirm a shift right away, that shift waits as pending. At the end of your time with an employer, they confirm your full total. If there is ever a disagreement about a shift, Olera will help you and your employer work it out." } },
    ...
    { step: { n: 9, title: "You can keep going after you finish.", body: "After the program, you are welcome to keep using Olera to work with families and agencies for as long as you want. Your application help stays free." } },
    { h2: "What you get" },
    { bullets: ["families and agencies to work with near you", "confirmed patient-care hours you can prove", "reviews from your employers", "references, if an employer had a good experience with you", "a letter of recommendation, if an employer feels you earned one. Olera gives them a short summary of your work and a template to make it easy. You ask for the letter, and they decide.", "your certificate", "help with your resume, your personal statement, and a practice interview"] },
    { h2: "What Olera does, and does not do" },
    { pkv: ["Olera does:", "connect you with families and agencies, keep your records and your hours, and give you your certificate and your application help."] },
    { pkv: ["Olera does not:", "employ you or pay you (your employer does), act as your insurer, or promise you a job, a certain amount of pay, a certain number of hours, or admission to any school."] },
    { h2: "A few more things to know" },
    { bullets: [["When you pay:", "only after you accept a real offer. Never before."], ["More than one employer:", "the $200 covers all of them. Most students start with one."], ["If it does not work out with an employer:", "you can stop and find another. The hours you already earned stay yours."], ["If we change these terms:", "we will tell you and ask you to accept the new version."], ["Your privacy:", "we handle your information under our privacy policy."]] },
    { h2: "Your agreement" },
    { p: "When you click accept, you are signing this agreement. You confirm that you have read it, that you qualify to join, and that you agree to how the program works as described here. We record the date you accepted." },
    { sign: "Accepted by:   Student name ____________________    Date __________" },
  ],
};

// ── Employer (covers family and agency; differences marked inline) ───────────
const EMPLOYER = {
  tag: "Student Caregiver Program · Employers",
  title: "Olera Employer Agreement",
  blocks: [
    { lead: "This agreement explains how it works to bring on an Olera student caregiver, and what you agree to. It is written for you, the employer. You are either a family caring for a loved one at home, or a care agency. Most of this is the same for both. Where it is different, we say so. There is no fee to bring on a student." },
    { h2: "What this is" },
    { p: "You bring on an Olera student caregiver, a pre-health student who wants real caregiving experience, to help with care. You are their employer. Olera connects you with the student, runs the program, and keeps the records. Olera is not the employer and is not involved in the care itself. More on that below." },
    { h2: "How it works, step by step" },
    { step: { n: 1, title: "You decide to bring on a student.", bullets: ["If you are an agency: you confirm you are a licensed or registered care agency.", "If you are a family: you are bringing on a student caregiver in your own home to help care for a family member."] } },
    ...
    { step: { n: 8, title: "After the program.", body: "If it works out, you are welcome to keep the student on for the long term, and to keep using Olera." } },
    { h2: "Who is responsible for what" },
    { bullets: ["You (the employer): employ the student, set the schedule and pay, supervise the work, and confirm the hours.", "The student: does the care, logs each shift, and keeps their profile current.", "Olera: connects you with students, runs the program, keeps the records, and (for families) helps you do this safely."] },
    ...
    { h2: "What Olera does, and does not do" },
    { p: "Olera does: connect you with students, run the program, keep the records, and help families do this safely." },
    { p: "Olera does not: employ the student, pay the student (you do), act as an insurer, or promise any outcome." },
    { h2: "A few more things to know" },
    { bullets: [["No fee:", "there is no fee to bring on a student."], ["Your choice:", "you are never required to send an offer or to keep a student."], ["If we change these terms:", "we will tell you and ask you to accept the new version."], ["Your privacy:", "we handle your information under our privacy policy."]] },
    { h2: "Your agreement" },
    { p: "When you send an offer, you are signing this agreement. You confirm that you have read it, that the role of employer is yours, and that you agree to how this works as described here. We record the date you accepted." },
    { sign: "Accepted by:   Employer name ____________________    Date __________" },
  ],
};
