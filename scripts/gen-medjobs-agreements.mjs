...
const STUDENT = {
  ...
  blocks: [
    ...
    { p: "Olera matches pre-health students with local home care agencies for paid caregiving work. You get real, paid experience caring for older adults — plus mentorship, references, and a recommendation letter you can use on your applications to nursing, PA, medical, and other health programs." },
    { p: "The agency you work for is your employer. Olera makes the match and supports you along the way; Olera does not employ or pay you. There is no fee to join." },
    { h2: "How it works, step by step" },
    { step: { n: 1, title: "You join.", body: "You can join if you are a currently enrolled student pursuing a health career and you want real patient-care experience. When you join, you confirm that this is true. There is nothing to pay." } },
    { step: { n: 2, title: "You get matched and accept an offer.", body: "Olera matches you with local home care agencies looking for caregivers. You can talk with them before you decide. When an agency wants to bring you on, they make you an offer. You choose the offer you want and accept it. You are never required to accept one." } },
    { step: { n: 3, title: "You get ready before your first shift.", body: "Before you start, you complete a short training, finish your profile, and upload any documents we ask for, such as proof of certifications. You agree to finish these before your first shift. This keeps you and the people you care for safe." } },
    { step: { n: 4, title: "You work your shifts.", body: "The agency is your employer. They set your schedule, pay you through their payroll, and supervise your work. Olera does not set your pay and does not pay you.\n\nWhile you work, you agree to:", bullets: ["show up on time, and tell your employer early if your plans change", "only do tasks you have been trained for", "keep private what you learn about the people you care for", "keep your profile up to date, so agencies know when you are available"] } },
    { step: { n: 5, title: "You build your record.", body: "As you work, you earn experience and reviews from the agencies you work with. When you have earned it, you can also earn references and a recommendation letter. For a letter, Olera gives your employer a short summary of your work and a simple template. You ask, and they decide.\n\nAfter the program, you are welcome to keep working with agencies through Olera for as long as you want. Your application help stays free." } },
    { h2: "What you get" },
    { bullets: ["local home care agencies to work with", "real, paid patient-care experience", "mentorship from Dr. DuBose's team", "reviews from the agencies you work with", "references, if an employer had a good experience with you", "a recommendation letter, if an employer feels you earned one. Olera gives them a short summary of your work and a template to make it easy. You ask, and they decide.", "help with your resume, your personal statement, and a practice interview"] },
    { h2: "What Olera does, and does not do" },
    { pkv: ["Olera does:", "match you with home care agencies, support you through the program, and help with your applications."] },
    ...
    { bullets: [["No fee:", "it is free to join and free to stay."], ["More than one employer:", "you can work with more than one agency over time."], ["If it does not work out with an employer:", "you can stop and find another match."], ["If we change these terms:", "we will tell you and ask you to accept the new version."], ["Your privacy:", "we handle your information under our privacy policy."]] },
    { h2: "Your agreement" },
