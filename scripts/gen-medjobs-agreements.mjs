...
const STUDENT = {
  ...
  blocks: [
    { lead: "This agreement explains how the Olera program works and what you agree to when you join. It is written for you, the student. If you ever have a question about how the program works, this is the place to find the answer. Please read it before you accept your first host." },
    ...
    { p: "Olera runs the program and keeps your records. Olera does not employ you. Your host does. More on that below." },
...
const HOST = {
  tag: "Student Caregiver Program · Hosts",
  title: "Olera Host Agreement",
  blocks: [
    { lead: "This agreement explains how it works to bring on an Olera student caregiver, and what you agree to. It is written for you, the host. A host is either a family caring for a loved one at home, or a care agency. Most of this is the same for both. Where it is different, we say so. There is no fee to host." },
    { h2: "What hosting is" },
    ...
    { h2: "How it works, step by step" },
    { step: { n: 1, title: "You decide to host.", bullets: ["If you are an agency: you confirm you are a licensed or registered care agency.", "If you are a family: you are bringing on a student caregiver in your own home to help care for a family member."] } },
    ...
    { bullets: ["You (the host): employ the student, set the schedule and pay, supervise the work, and confirm the hours.", "The student: does the care, logs each shift, and keeps their profile current.", "Olera: connects you with students, runs the program, keeps the records, and (for families) helps you host safely."] },
    ...
    { h2: "What Olera does, and does not do" },
    { p: "Olera does: connect you with students, run the program, keep the records, and help family hosts do this safely." },
