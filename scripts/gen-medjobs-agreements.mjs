...
const EMPLOYER = {
  ...
  blocks: [
    { lead: "This agreement explains how it works to bring on an Olera student caregiver, and what you agree to. It is written for you, the provider — a licensed or registered home care agency. The pilot is free — you can browse, interview, and hire students at no cost." },
    { h2: "What this is" },
    ...
    { step: { n: 3, title: "You hire — free during the pilot.", body: "When you hire a student, there is no placement fee during the pilot; browsing, interviewing, and hiring are all free. If we continue the program beyond the pilot, we will agree any terms — including fees, if any — with you in writing first." } },
    ...
    { h2: "A few more things to know" },
    { bullets: [["Free during the pilot:", "no cost to review candidates, interview, connect, or hire."], ["Beyond the pilot:", "if we continue together, we will agree any terms — including fees, if any — in writing first."], ["Your choice:", "you are never required to make an offer or to keep a student."], ["If we change these terms:", "we will tell you and ask you to accept the new version."], ["Your privacy:", "we handle your information under our privacy policy."]] },
    { h2: "Your agreement" },
