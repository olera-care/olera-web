-- ─────────────────────────────────────────────────────────────────────────
-- Student Outreach v8.9 demo seed — Texas A&M + University of Houston.
--
...
-- the v8.9 panel surfaces — including the new contact-name-primary
-- header, "Dr." title personalization, and restructured drawer.
--
--   Research tab
...
BEGIN
  ...
  RAISE NOTICE 'Seeded 18 student-outreach demo rows across Texas A&M (%) and University of Houston (%).', tamu_id, uh_id;
END $$;
