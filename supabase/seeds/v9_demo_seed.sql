...
INSERT INTO business_profiles (id, type, slug, display_name, business_name, email, phone, city, state, is_active, created_at, metadata) VALUES
  -- Duke catchment (Durham/Chapel Hill/Raleigh)
  ('00000000-0000-0000-aa00-000000000001', 'organization', 'demo-triangle-home-care',         'Triangle Home Care',         'Triangle Home Care',         'contact@trianglehomecare.example',         '+19195551001', 'Durham',          'NC', true, NOW() - INTERVAL '120 days', jsonb_build_object('demo_data_v1', true, 'interview_terms_accepted_at', (NOW() - INTERVAL '60 days')::text, 'medjobs_credits_used', 3)),
  ('00000000-0000-0000-aa00-000000000002', 'organization', 'demo-bull-city-caregivers',       'Bull City Caregivers',       'Bull City Caregivers',       'contact@bullcitycaregivers.example',       '+19195551002', 'Durham',          'NC', true, NOW() - INTERVAL '90 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000003', 'organization', 'demo-tobacco-road-senior',        'Tobacco Road Senior Services','Tobacco Road Senior Services','contact@tobaccoroadseniorservices.example','+19195551003', 'Durham',          'NC', true, NOW() - INTERVAL '85 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000004', 'organization', 'demo-carolina-companions',        'Carolina Companions',        'Carolina Companions',        'contact@carolinacompanions.example',        '+19195551004', 'Chapel Hill',     'NC', true, NOW() - INTERVAL '70 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000005', 'organization', 'demo-research-triangle-care',     'Research Triangle Care',     'Research Triangle Care',     'contact@researchtrianglecare.example',     '+19195551005', 'Raleigh',         'NC', true, NOW() - INTERVAL '50 days',  jsonb_build_object('demo_data_v1', true)),
  -- U Florida catchment (Gainesville)
  ('00000000-0000-0000-aa00-000000000006', 'organization', 'demo-gator-care-services',        'Gator Care Services',        'Gator Care Services',        'contact@gatorcareservices.example',        '+13525551006', 'Gainesville',     'FL', true, NOW() - INTERVAL '60 days',  jsonb_build_object('demo_data_v1', true, 'interview_terms_accepted_at', (NOW() - INTERVAL '30 days')::text, 'medjobs_credits_used', 1)),
  ('00000000-0000-0000-aa00-000000000007', 'organization', 'demo-sunshine-home-health',       'Sunshine Home Health',       'Sunshine Home Health',       'contact@sunshinehomehealth.example',       '+13525551007', 'Gainesville',     'FL', true, NOW() - INTERVAL '45 days',  jsonb_build_object('demo_data_v1', true)),
  -- Vanderbilt catchment (Nashville/Murfreesboro/Franklin)
  ('00000000-0000-0000-aa00-000000000008', 'organization', 'demo-music-city-home-health',     'Music City Home Health',     'Music City Home Health',     'contact@musiccityhomehealth.example',     '+16155551008', 'Nashville',       'TN', true, NOW() - INTERVAL '180 days', jsonb_build_object('demo_data_v1', true, 'interview_terms_accepted_at', (NOW() - INTERVAL '100 days')::text, 'medjobs_credits_used', 8, 'medjobs_subscription_active', true, 'medjobs_stripe_customer_id', 'cus_demoMusicCity', 'medjobs_subscription_id', 'sub_demo01234567')),
  ('00000000-0000-0000-aa00-000000000009', 'organization', 'demo-cumberland-caregivers',      'Cumberland Caregivers',      'Cumberland Caregivers',      'contact@cumberlandcaregivers.example',     '+16155551009', 'Nashville',       'TN', true, NOW() - INTERVAL '110 days', jsonb_build_object('demo_data_v1', true, 'interview_terms_accepted_at', (NOW() - INTERVAL '80 days')::text, 'medjobs_credits_used', 4)),
  ('00000000-0000-0000-aa00-000000000010', 'organization', 'demo-tennessee-senior-solutions', 'Tennessee Senior Solutions', 'Tennessee Senior Solutions', 'contact@tennesseeseniorsolutions.example', '+16155551010', 'Nashville',       'TN', true, NOW() - INTERVAL '120 days', jsonb_build_object('demo_data_v1', true, 'interview_terms_accepted_at', (NOW() - INTERVAL '95 days')::text, 'medjobs_credits_used', 2)),
  ('00000000-0000-0000-aa00-000000000011', 'organization', 'demo-smoky-mountain-care',        'Smoky Mountain Care',        'Smoky Mountain Care',        'contact@smokymountaincare.example',        '+16155551011', 'Murfreesboro',    'TN', true, NOW() - INTERVAL '40 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000012', 'organization', 'demo-hatch-show-caregivers',      'Hatch Show Caregivers',      'Hatch Show Caregivers',      'contact@hatchshowcaregivers.example',      '+16155551012', 'Franklin',        'TN', true, NOW() - INTERVAL '220 days', jsonb_build_object('demo_data_v1', true)),
  -- UT Austin catchment (Austin/Round Rock/Cedar Park) — Stage 1 prospects
  ('00000000-0000-0000-aa00-000000000013', 'organization', 'demo-sunshine-senior-care',       'Sunshine Senior Care',       'Sunshine Senior Care',       'contact@sunshineseniorcare.example',       '+15125551013', 'Austin',          'TX', true, NOW() - INTERVAL '40 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000014', 'organization', 'demo-capital-caregivers',         'Capital Caregivers',         'Capital Caregivers',         'contact@capitalcaregivers.example',         '+15125551014', 'Austin',          'TX', true, NOW() - INTERVAL '38 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000015', 'organization', 'demo-hill-country-home-health',   'Hill Country Home Health',   'Hill Country Home Health',   'contact@hillcountryhomehealth.example',     '+15125551015', 'Round Rock',      'TX', true, NOW() - INTERVAL '35 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000016', 'organization', 'demo-lone-star-companions',       'Lone Star Companions',       'Lone Star Companions',       'contact@lonestarcompanions.example',         '+15125551016', 'Cedar Park',      'TX', true, NOW() - INTERVAL '32 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000017', 'organization', 'demo-alamo-family-care',          'Alamo Family Care',          'Alamo Family Care',          'contact@alamofamilycare.example',           '+15125551017', 'Austin',          'TX', true, NOW() - INTERVAL '28 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000018', 'organization', 'demo-bluebonnet-in-home',         'Bluebonnet In-Home Services','Bluebonnet In-Home Services','contact@bluebonnetinhomeservices.example', '+15125551018', 'Round Rock',      'TX', true, NOW() - INTERVAL '24 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000019', 'organization', 'demo-texas-care-connect',         'Texas Care Connect',         'Texas Care Connect',         'contact@texascareconnect.example',         '+15125551019', 'Austin',          'TX', true, NOW() - INTERVAL '20 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000020', 'organization', 'demo-live-oak-caregivers',        'Live Oak Caregivers',        'Live Oak Caregivers',        'contact@liveoakcaregivers.example',         '+15125551020', 'Cedar Park',      'TX', true, NOW() - INTERVAL '15 days',  jsonb_build_object('demo_data_v1', true)),
  -- UVA catchment (Charlottesville)
  ('00000000-0000-0000-aa00-000000000021', 'organization', 'demo-blue-ridge-care-services',   'Blue Ridge Care Services',   'Blue Ridge Care Services',   'contact@blueridgecareservices.example',     '+14345551021', 'Charlottesville', 'VA', true, NOW() - INTERVAL '90 days',  jsonb_build_object('demo_data_v1', true)),
  ('00000000-0000-0000-aa00-000000000022', 'organization', 'demo-cavalier-companions',        'Cavalier Companions',        'Cavalier Companions',        'contact@cavaliercompanions.example',         '+14345551022', 'Charlottesville', 'VA', true, NOW() - INTERVAL '85 days',  jsonb_build_object('demo_data_v1', true));
