...
-- Note: meeting_at is NOT a column on student_outreach — it's derived
-- from the meeting_scheduled touchpoint's payload at read time. Row #5
-- (Office of Pre-Health, meeting_scheduled) carries the meeting time
-- in the touchpoint below, not on the outreach row.
INSERT INTO student_outreach (id, campus_id, stakeholder_type, kind, provider_business_profile_id, organization_name, department, programs, status, contact_permission, research_data, cadence_day, notes, viewed_at, last_edited_at, created_at, distribution_evidence, distribution_evidence_notes, redirected_to_id) VALUES
  -- Duke
  ('00000000-0000-0000-cc00-000000000001', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'student_org', 'student_org', NULL, 'Pre-Med Society at Duke',     'Student Organizations', '{}', 'prospect',          'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NULL,                       NOW() - INTERVAL '0 days',  NOW() - INTERVAL '1 day',   NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000002', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'advisor',     'advisor',     NULL, 'Duke Pre-Health Advising',    'Office of the Dean',    '{}', 'researched',        'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NULL,                       NOW() - INTERVAL '1 day',   NOW() - INTERVAL '2 days',  NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000003', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'dept_head',   'dept_head',   NULL, 'Duke Department of Biology',  'Biology',               '{}', 'outreach_sent',     'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '4 hours', NOW() - INTERVAL '2 days',  NOW() - INTERVAL '5 days',  NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000004', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'student_org', 'student_org', NULL, 'Duke Pre-PA Society',         'Student Organizations', '{}', 'engaged',           'not_yet', '{}', 6, '[DEMO_DATA_V1] ', NULL,                       NOW() - INTERVAL '8 minutes',NOW() - INTERVAL '7 days',  NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000005', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'advisor',     'advisor',     NULL, 'Office of Pre-Health',        'Trinity College',       '{}', 'meeting_scheduled', 'not_yet', '{}', 6, '[DEMO_DATA_V1] ', NOW() - INTERVAL '2 days',  NOW() - INTERVAL '4 days',  NOW() - INTERVAL '10 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000006', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'dept_head',   'dept_head',   NULL, 'Duke School of Nursing',      'Nursing',               '{}', 'agreed',            'not_yet', '{}', 12,'[DEMO_DATA_V1] ', NOW() - INTERVAL '3 days',  NOW() - INTERVAL '6 days',  NOW() - INTERVAL '14 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000007', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'advisor',     'advisor',     NULL, 'Duke Health Sciences Office', 'Pre-Health Programs',   '{}', 'engaged',           'not_yet', '{}', 9, '[DEMO_DATA_V1] Met in person at career fair. Wants more details before sharing.', NULL, NOW() - INTERVAL '1 day',   NOW() - INTERVAL '16 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000008', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       'student_org', 'student_org', NULL, 'Coach K''s Office',            'Athletics — Pre-Med Liaison','{}', 'engaged',         'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NULL,                       NOW() - INTERVAL '1 day',   NOW() - INTERVAL '8 days',  NULL, NULL, NULL),
  -- Duke materialized provider (kind='provider', stakeholder_type=NULL)
  ('00000000-0000-0000-cc00-000000000009', (SELECT id FROM student_outreach_campuses WHERE slug = 'duke'),       NULL,          'provider',    '00000000-0000-0000-aa00-000000000002', 'Bull City Caregivers', NULL, '{}', 'outreach_sent', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '1 day',   NOW() - INTERVAL '3 days',  NOW() - INTERVAL '5 days',  NULL, NULL, NULL),
  -- Vanderbilt
  ('00000000-0000-0000-cc00-000000000010', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), 'student_org', 'student_org', NULL, 'Vanderbilt Pre-Med Society',  'Student Organizations', '{}', 'active_partner', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '20 days', NOW() - INTERVAL '30 days', NOW() - INTERVAL '95 days', 'observed_external', 'Saw their newsletter linking our profiles 3 weeks ago.', NULL),
  ('00000000-0000-0000-cc00-000000000011', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), 'advisor',     'advisor',     NULL, 'Vanderbilt Pre-Health Advising','Career Center',         '{}', 'active_partner', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '50 days', NOW() - INTERVAL '60 days', NOW() - INTERVAL '115 days', 'explicit_email',     'Confirmed in email — sharing with the pre-health listserv quarterly.', NULL),
  ('00000000-0000-0000-cc00-000000000012', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), 'dept_head',   'dept_head',   NULL, 'Vandy School of Nursing',     'Nursing',               '{}', 'active_partner', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '40 days', NOW() - INTERVAL '45 days', NOW() - INTERVAL '75 days', 'self_reported',      'Tracking via the spring intake survey.', NULL),
  ('00000000-0000-0000-cc00-000000000013', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), 'dept_head',   'dept_head',   NULL, 'Vanderbilt Public Health',    'Public Health',         '{}', 'distributed',    'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '10 days', NOW() - INTERVAL '15 days', NOW() - INTERVAL '45 days', 'explicit_verbal',    'Confirmed verbally in a meeting that they''ve shared the program.', NULL),
  ('00000000-0000-0000-cc00-000000000014', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), 'student_org', 'student_org', NULL, 'Vanderbilt Pre-PA Club',      'Student Organizations', '{}', 'outreach_sent', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '3 days',  NOW() - INTERVAL '4 days',  NOW() - INTERVAL '6 days',  NULL, NULL, NULL),
  -- Vanderbilt historical provider partner
  ('00000000-0000-0000-cc00-000000000015', (SELECT id FROM student_outreach_campuses WHERE slug = 'vanderbilt'), NULL,          'provider',    '00000000-0000-0000-aa00-000000000012', 'Hatch Show Caregivers', NULL, '{}', 'active_partner', 'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '100 days', NOW() - INTERVAL '120 days', NOW() - INTERVAL '210 days', 'self_reported', 'Provider was an early adopter. Now regularly hires from our pool.', NULL),
  -- UVA terminal-state graveyard
  ('00000000-0000-0000-cc00-000000000016', (SELECT id FROM student_outreach_campuses WHERE slug = 'uva'),        'student_org', 'student_org', NULL, 'UVA Pre-Med Society',         'Student Organizations', '{}', 'not_interested',     'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '15 days', NOW() - INTERVAL '20 days', NOW() - INTERVAL '35 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000017', (SELECT id FROM student_outreach_campuses WHERE slug = 'uva'),        'advisor',     'advisor',     NULL, 'UVA Pre-Health Advising',     'Office of the Dean',    '{}', 'no_response_closed', 'not_yet', '{}', 14,'[DEMO_DATA_V1] ', NOW() - INTERVAL '30 days', NOW() - INTERVAL '35 days', NOW() - INTERVAL '65 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000018', (SELECT id FROM student_outreach_campuses WHERE slug = 'uva'),        'dept_head',   'dept_head',   NULL, 'UVA Health Sciences',         'Health Sciences',       '{}', 'do_not_contact',     'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '40 days', NOW() - INTERVAL '50 days', NOW() - INTERVAL '75 days', NULL, NULL, NULL),
  ('00000000-0000-0000-cc00-000000000019', (SELECT id FROM student_outreach_campuses WHERE slug = 'uva'),        'professor',   'professor',   NULL, 'UVA Biology',                 'Biology',               '{}', 'wrong_contact',      'via_dept', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '20 days', NOW() - INTERVAL '25 days', NOW() - INTERVAL '35 days', NULL, NULL, NULL),
  -- Redirected row (points at Duke #1)
  ('00000000-0000-0000-cc00-000000000020', (SELECT id FROM student_outreach_campuses WHERE slug = 'uva'),        'student_org', 'student_org', NULL, 'UVA Pre-PA Club',             'Student Organizations', '{}', 'redirected',         'not_yet', '{}', 0, '[DEMO_DATA_V1] ', NOW() - INTERVAL '15 days', NOW() - INTERVAL '18 days', NOW() - INTERVAL '30 days', NULL, NULL, '00000000-0000-0000-cc00-000000000001');
